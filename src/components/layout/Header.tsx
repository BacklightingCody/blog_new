...
const Header = () => {
  ...
  return (
    <header className={clsx('z-100 sticky top-0 py-4 flex justify-around items-center w-full p-[16%]  h-16  transform translate-z-0 backdrop-saturate-180 backdrop-blur dark:bg-black/30 ', y > threshold && styles.shadow)}>
